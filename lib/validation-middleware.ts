...
export function addSecurityHeaders(response: NextResponse): NextResponse {
  ...
  // Allow camera/microphone for face recognition pages, block for others
  if (request.nextUrl.pathname.startsWith('/face') || request.nextUrl.pathname.startsWith('/employee')) {
